--- Module for parsing signatures. Imported from ltypekit7.
-- @module ltypekit-parser.init
-- @author daelvn
import p, y, colorall from require "ltypekit-parser.config"
...
compare = (base) -> (against) ->
  ...
  elseif base.__list and against.__list -- Compare two lists
    ...
    unless r
      ...
      return false, err
    return true
  elseif base.__table and against.__table -- Compare two tables
    p "compare/table"
...

{
  ...
  :applToPattern
  :binarize, :rbinarize
  :annotatePar, :annotate
  :compareAppl, :compare
  :normalizeContext, :mergeContext
}
